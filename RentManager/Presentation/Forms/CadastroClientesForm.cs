...
namespace RentManager
{
    public partial class CadastroClientesForm : Form
    {
        ...
        public CadastroClientesForm(RentManagerDataBase db, Cliente cliente = null)
        {
            InitializeComponent();
            _db = db;
        ...
        private void CadastroClientesForm_Load(object sender, EventArgs e)
        {
            ...
            designTextBoxNomeCliente.Focus();
        }
        ...
        private void CarregarCliente()
        {
            ...
            designTextBoxID.Text = _cliente.ID.ToString();
